  ...
  return (
    <Layout location={location} >
      ...
      <Wrapper className='inner'>
        ...
        <p>当ブログの情報は、可能な限り正確を期するよう努めておりますが、その内容の正確性や安全性を保障するものではありません。万が一, 当ブログの情報のご利用等により何らかの不都合や損失が発生したとしても, 当ブログでは一切の責任を負いかねます。</p>
        <p>また、当ブログに掲載した情報は、予告なく変更・削除される可能性があります。</p>
        <p>あらかじめご了承ください。</p>
      </Wrapper>
    </Layout>
  )
